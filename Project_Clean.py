...
def read_ground_truth(file_path):
    ...
    with open(file_path, "r") as file:
        ...
        for line in lines:
            ...
            if line.startswith("generated_audio"):
                current_audio = line
...
ground_truth_file = "/Users/dohahammouda/Desktop/Project1/Translation_Transcription_Clean.txt"
ground_truth_data = read_ground_truth(ground_truth_file)

# Get the generated audios
audio_folder = "/Users/dohahammouda/Desktop/Project1/audio/Clean_Audio"
audio_files = []
...
for audio_file in audio_files:
  ...
  # Get translation and transcription text for this audio file
    if file_name in ground_truth_data:
        ...
        print(f"No ground truth data found for {file_name}.")

        #here all audios are transcribed and translated but it's the same code as the other one so i didn't remove the condition